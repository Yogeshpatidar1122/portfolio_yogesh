...
export const projectsData = [
    {
        id: 1,
        name: 'Sens AI',
        description: "Sens AI is an advanced AI-powered tool designed to craft professional resumes, cover letters, and assist with interview preparation.Built with cutting - edge technologies, it features a sleek design using ShadCN, efficient data handling with Neon Database(PostgreSQL) and Prisma ORM, and seamless workflow automation with Inngest.Powered by Gemini AI, Sens AI ensures top - notch career support with intelligent and personalized insights.",
        tools: [, 'PostgressDB', 'Next.js', 'Shadecn', 'Inngest', 'TailwindCss', 'NeonDB', 'Prisma ORM'],
        role: 'Full Stack Developer',
        code: 'https://github.com/Yogeshpatidar1122/Sensai',
        demo: 'https://sensai-nu-lilac.vercel.app/',
